...
def main():
    ...
    model = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=64),
        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=64),
        tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2),

        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=128),
        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=128),
        tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2),

        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=256),
        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=256),
        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=256),
        tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2),

        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=512),
        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=512),
        tf.keras.layers.Conv2D(kernel_size=(3, 3), padding='same', activation='relu', filters=512),
        tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2),
